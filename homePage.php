...
<button class="w3-button w3-padding-large custom-back-colour2" style="margin-top:64px" onclick="RSVPClick()">RSVP</button>
</div>
...
<div class="bgimg-5 w3-display-container">
  <div class="w3-display-middle heading-shader">
      <span class="w3-large w3-text-white w3-wide w3-display-small w3-hide-large w3-hide-medium">ACCOMMODATION</span>
     <span class="w3-xxlarge w3-text-white w3-wide w3-display-medium w3-hide-small w3-hide-large">ACCOMMODATION</span>
...
<div class="w3-col m6 w3-panel">
    ...
    <button id="sendMail" name="sendMail" type="button" class="w3-button w3-right w3-section custom-back-colour2">
...
<!-- Footer -->
<footer class="w3-center w3-padding-64 custom-back-colour2" style="color:black">
