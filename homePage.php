...
<div class="w3-content w3-container w3-padding-64 w3-sepia-min custom-back-colour1 custom-temporary" id="registryList">
    ...
    <div class="w3-display-middle w3-hide-medium w3-hide-large custom-back-colour2">
        <h1 class="w3-center w3-padding-large w3-wide w3-small w3-animate-opacity custom-colour1" style="min-width: 80%">Bear with us... we are still trying to decide whether we <i>actually</i> need a cat shaped teapot...</h1>
  </div>
