...
<div id="modal02" class="w3-modal w3-sand w3-opacity"">
  <span class="w3-button w3-large w3-sand w3-display-topright" onclick="this.parentElement.style.display='none'" title="Close Modal RSVP"><i class="fa fa-remove"></i></span>
  <div class="w3-modal-content w3-animate-zoom w3-center w3-sand 64" id="modal02Content">
	  <div class="w3-card-4">
			<div class="w3-container w3-brown">
				<h2>RSVP</h2>
			</div>
			<form id="RSVP" class="w3-container">
			<label>First Name</label>
			<input class="w3-input" type="text" id="firstName" name="firstName">
			<label>Surname</label>
			<input class="w3-input" type="text" id="surname" name="surname">
			<label>Contact Details</label>
			<input class="w3-input" type="number" id="cell" name="cell">
			<label>Email Address</label>
			<input class="w3-input" type="email" id="mail" name="mail">
			<label>Comments</label>
			<input class="w3-input" type="text" id="comment" name="comment">
			
			<input class="w3-check" type="checkbox" checked="checked" id="kAcq" name="kAcq">
			<label>acquainted with Kajal</label>
			<input class="w3-check" type="checkbox" id="bAcq" name="bAcq">
			<label>acquainted with Brandon</label>
			<select class="w3-select" name="option" id="group" name="group">
			<label>Look at the attendence to see which group is sitting where</label>
			...
			<button class="w3-button w3-padding-large w3-light-grey" style="margin-top:20px;margin-bottom:10px" onclick="RSVPClick()">RSVP</button>
			</form>
		</div>
	</div>
</div>
